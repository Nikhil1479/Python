...
import pandas as pd
import re
df1 = pd.read_xml("/content/customer1113697_loan1115483_crif_report.html.xml",
                  xpath="//LOAN-DETAILS")
df2 = pd.read_xml(
    "/content/customer1129550_loan1131339_crif_repocleatrt.html.xml", xpath="//LOAN-DETAILS")
df3 = pd.read_xml(
    "/content/customer1195586_loan1197471_crif_report.html.xml", xpath="//LOAN-DETAILS")
df4 = pd.read_xml(
    "/content/customer14235_loan14235_crif_report.html.xml", xpath="//LOAN-DETAILS")
df5 = pd.read_xml(
    "/content/customer16475_loan16475_crif_report.html.xml", xpath="//LOAN-DETAILS")
df6 = pd.read_xml(
    "/content/customer40409_loan40409_crif_report.html.xml", xpath="//LOAN-DETAILS")
df7 = pd.read_xml(
    "/content/customer773504_loan774538_crif_report.html.xml", xpath="//LOAN-DETAILS")
df8 = pd.read_xml(
    "/content/customer787561_loan788638_crif_report.html.xml", xpath="//LOAN-DETAILS")
df9 = pd.read_xml(
    "/content/customer794397_loan795497_crif_report.html.xml", xpath="//LOAN-DETAILS")
df10 = pd.read_xml(
    "/content/customer898231_loan899591_crif_report.html.xml", xpath="//LOAN-DETAILS")
...
cph_list = [df1["COMBINED-PAYMENT-HISTORY"], df2["COMBINED-PAYMENT-HISTORY"], df3["COMBINED-PAYMENT-HISTORY"], df4["COMBINED-PAYMENT-HISTORY"],
            df5["COMBINED-PAYMENT-HISTORY"], df6["COMBINED-PAYMENT-HISTORY"], df7, df8["COMBINED-PAYMENT-HISTORY"], df9["COMBINED-PAYMENT-HISTORY"], df10["COMBINED-PAYMENT-HISTORY"]]
...
df1 = pd.read_xml(
    "/content/customer1113697_loan1115483_crif_report.html.xml", xpath="//LOAN-DETAILS")
df2 = pd.read_xml(
    "/content/customer1129550_loan1131339_crif_report.html.xml", xpath="//LOAN-DETAILS")
df3 = pd.read_xml(
    "/content/customer1195586_loan1197471_crif_report.html.xml", xpath="//LOAN-DETAILS")
df4 = pd.read_xml(
    "/content/customer14235_loan14235_crif_report.html.xml", xpath="//LOAN-DETAILS")
...
l = [df1["COMBINED-PAYMENT-HISTORY"], df2["COMBINED-PAYMENT-HISTORY"], df3["COMBINED-PAYMENT-HISTORY"], df4["COMBINED-PAYMENT-HISTORY"], df5["COMBINED-PAYMENT-HISTORY"],
     df6["COMBINED-PAYMENT-HISTORY"], df7["COMBINED-PAYMENT-HISTORY"], df8["COMBINED-PAYMENT-HISTORY"], df9["COMBINED-PAYMENT-HISTORY"], df10["COMBINED-PAYMENT-HISTORY"]]
